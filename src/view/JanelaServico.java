...
public class JanelaServico extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTF_preco, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jTF_duracao, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_inserirActionPerformed(java.awt.event.ActionEvent evt) {
        Servico serv = CarregaServico();
        if (dao.Inserir(serv)) {
            JOptionPane.showMessageDialog(this, "Serviço inserido com sucesso.");
        } else {
            JOptionPane.showMessageDialog(this, "Erro ao inserir serviço.");
        }
    }
    ...
    public void ExibeRegistro(Servico serv) {
        jTF_id.setText(String.valueOf(serv.getId()));
        jTF_descricao.setText(serv.getDescricao());
        jTF_preco.setText(String.valueOf(serv.getPreco()));
        jTF_duracao.setText(String.valueOf(serv.getDuracaoMinutos()));
    }

    public Servico CarregaServico() {
        int id = Integer.valueOf(jTF_id.getText());
        String descricao = jTF_descricao.getText();
        double preco = Double.valueOf(jTF_preco.getText());
