...
public class JanelaFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setText("TELA DOS FUNCIONÁRIOS");
    ...
    private void btnAbreBancoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAbreBancoActionPerformed
        if (db.CriaConexao()) {
            dao = new FuncionarioDAO(db.getConnection());
    ...
    // ficou grande pois implemento um novo formulario aqui dentro
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            ...
            JTextField nomeField = new JTextField(func.getNome(), 20);
            JTextField telefoneField = new JTextField(func.getTelefone(), 20);
            JTextField salarioField = new JTextField(String.valueOf(func.getSalario()), 20);
            JTextField cargoField = new JTextField(func.getCargo(), 20);
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                func.setTelefone(telefoneField.getText().trim());
                func.setSalario(Double.parseDouble(salarioField.getText().trim()));
                func.setCargo(cargoField.getText().trim());
            ...
            JOptionPane.showMessageDialog(this, "Digite um ID e salário válidos.");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JanelaFuncionario().setVisible(true));
    }
